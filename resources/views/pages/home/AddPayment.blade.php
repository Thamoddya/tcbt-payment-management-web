                    ...
                    if (payments.length > 0) {
                        ...
                        payments.forEach(payment => {
                            ...
                            <tr>
                                ...
                                <td>${payment.status === 'Paid' ? new Date(payment.payment_date).toLocaleDateString('en-GB') : 'N/A'}</td>
                            </tr>`;
                        });
                        ...
                        $('#paymentsTableBody').html('<tr><td colspan="4" class="text-center">No payment or due data available.</td></tr>');
                        $('#paymentsSection').show();
                    }
